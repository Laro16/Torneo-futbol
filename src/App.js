...
// --- Gemini API Helper (Sin cambios) ---
const callGeminiAPI = async (prompt) => { /* ... tu código de la API ... */ };
...
export default function App() {
    ...
    useEffect(() => {
        // ==================================================================
        // ===== ESTA ES LA FUNCIÓN MEJORADA QUE ARREGLA EL PROBLEMA ========
        // ==================================================================
        const parseCSV = (csvText) => {
            if (!csvText) return [];

            // Esta expresión regular es más inteligente:
            // Separa por comas, pero ignora las comas que están dentro de "comillas"
            const regex = /(?:^|,)(\"(?:[^\"]+|\"\")*\"|[^,]*)/g;
            ...
            for (let i = 1; i < lines.length; i++) {
                ...
                while (match = regex.exec(line)) {
                    let value = match[1];
                    // Limpia las comillas del principio y final
    ...
    const handleTeamClick = async (team) => { /* ... tu código para el análisis ... */ };
